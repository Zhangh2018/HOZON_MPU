...
static asn_TYPE_member_t asn_MBR_APN2ConfigSet_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct APN2ConfigSet, tspAddress),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct APN2ConfigSet, tspUser),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct APN2ConfigSet, tspPass),
...
static const ber_tlv_tag_t asn_DEF_APN2ConfigSet_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_APN2ConfigSet_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* tspAddress */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* tspUser */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* tspPass */
};
static asn_SEQUENCE_specifics_t asn_SPC_APN2ConfigSet_specs_1 = {
	sizeof(struct APN2ConfigSet),
	offsetof(struct APN2ConfigSet, _asn_ctx),
	asn_MAP_APN2ConfigSet_tag2el_1,
	3,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_APN2ConfigSet = {
	"APN2ConfigSet",
	"APN2ConfigSet",
	SEQUENCE_free,
	SEQUENCE_print,
	...
	asn_DEF_APN2ConfigSet_tags_1,
	sizeof(asn_DEF_APN2ConfigSet_tags_1)
		/sizeof(asn_DEF_APN2ConfigSet_tags_1[0]), /* 1 */
	asn_DEF_APN2ConfigSet_tags_1,	/* Same as above */
	sizeof(asn_DEF_APN2ConfigSet_tags_1)
		/sizeof(asn_DEF_APN2ConfigSet_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_APN2ConfigSet_1,
	3,	/* Elements count */
	&asn_SPC_APN2ConfigSet_specs_1	/* Additional specs */
};
