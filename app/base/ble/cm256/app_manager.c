...
#define APP_XML_CONFIG_FILE_PATH            "/usrdata/bt/bt_config.xml"
#define APP_XML_REM_DEVICES_FILE_PATH       "/usrdata/bt/bt_devices.xml"
...
int api_get_bt_config(tBSA_DM_GET_CONFIG *bt_config)
{
    int status;
...
void app_mgr_security_callback(tBSA_SEC_EVT event, tBSA_SEC_MSG *p_data)
{
    ...
    case BSA_SEC_SP_CFM_REQ_EVT: /* Simple Pairing confirm request */
        APP_DEBUG0("lqfBSA_SEC_SP_CFM_REQ_EVT");
    ...
    case BSA_SEC_SP_KEY_NOTIF_EVT: /* Simple Pairing Passkey Notification */
        APP_DEBUG0("lqfBSA_SEC_SP_KEY_NOTIF_EVT");
